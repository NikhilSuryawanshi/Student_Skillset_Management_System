...
//out.print("<h3> user is "+usr+"</h3>");
	...
	if(rs.next())
	{
  	...
  	%>	
        ...
        <tr><th>skills</th><td><%=Dbcon.getSkill(usr, "Std_home.jsp") %></td></tr>
  		
 		
<%
Dbcon.closeCon("Std_home.jsp");
	}
